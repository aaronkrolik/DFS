...
public abstract class AbstractDBufferCache {
	 ...
	 */
	public AbstractDBufferCache(int cacheSize) {
	 ...
	 * cannot change.
	 */
	public abstract DBuffer getBlock(int blockID) throws IllegalArgumentException, IOException;
	 ...
	 */
	public abstract void sync() throws IllegalArgumentException, IOException;
}